...
def produce_present(args):
    ...
    xp_schedule = [['centrality_final_redo', ['imagenet'], ['betweenness', 'evector', 'closeness', 'degree', 'betweenness_WT', 'degree_WT', 'evector_WT', 'closeness_WT']]]
    ...
    for i in range(len(xp_schedule)):
        ...
        for ds in xp_datasets:
            for cent in xp_centrality:
                tcs = ct_centrality_dict[cent][ds]
                for tc in tcs:
